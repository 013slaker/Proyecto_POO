 ...
 *
 * Esta es la ÚNICA pantalla donde se CREAN asistencias nuevas. La
 * ficha individual del alumno (AsistenciaVista) solo permite CONSULTAR
 * el historial y JUSTIFICAR una falta puntual — no crea registros
...
public class RegistroAsistenciaVista extends JPanel {
    ...
    private void initComponentes() {
        ...
        // la ficha individual del alumno)
        //------------------------------------------------------
